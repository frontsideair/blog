...
### Selective Hydration
This ties in with Streaming SSR, as hydration is no longer an uninterruptible process, [selective hydration](https://github.com/reactwg/react-18/discussions/130) improves the first input delay metric if you have some suspense boundaries in your tree. React can also prioritize subtrees that the user interacts with, and replay events after hydration is done.
